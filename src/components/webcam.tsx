...
export interface WebcamProps extends Omit<React.HTMLProps<HTMLVideoElement>, "ref" | "children"> {
  audio?: boolean;
...
export function Webcam({
  ...
  }, [audio, audioConstraints, videoConstraints, onUserMedia, onUserMediaError]);

  const getCanvas = useCallback((screenshotDimensions?: ScreenshotDimensions) => {
    ...
    return canvas;
  }, [hasUserMedia, forceScreenshotSourceSize, minScreenshotWidth, minScreenshotHeight, mirrored, imageSmoothing]);

  const getScreenshot = useCallback((screenshotDimensions?: ScreenshotDimensions) => {
  ...
  useEffect(() => {
    ...
    ctxRef.current = null;
  }, [videoConstraints, minScreenshotWidth, minScreenshotHeight]);
